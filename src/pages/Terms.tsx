    ...
    <main className="p-10 max-w-5xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow p-6">
        ...
        <p className="text-gray-600 mt-2">
          Welcome to our Terms and Conditions. This document outlines the rules
        ...
        <Link
          to="/contact"
          className="mt-4 block text-center bg-primary text-white py-2 rounded hover:bg-primary-dark"
        >
          Contact Us
        </Link>
      </div>
