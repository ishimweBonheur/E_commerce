...
export default function FilterBar({ orders, handleFilter, search }: PageProps) {
  return (
    <div className="mb-4 flex justify-between">
      ...
      <div className="flex gap-2 w-64 border border-gray-500 rounded items-center bg-white p-2">
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
